...
def main():
    ...
    with tab_viz:
        ...
        with c_comp:
            ...
            c_f.button("❄️ Freeze", on_click=on_freeze_baseline, use_container_width=True, help="Set current run as baseline")
            c_c.button("🧹 Clear", on_click=on_clear_baseline, use_container_width=True, help="Remove baseline")
